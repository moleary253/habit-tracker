// Source: https://raw.githubusercontent.com/plotters-rs/plotters/master/plotters/examples/console.rs
...
impl TextDrawingBackend {
    pub fn new(size: usize) -> TextDrawingBackend {
        TextDrawingBackend(vec![PixelState::Empty; size])
    }
}
